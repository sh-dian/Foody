<?php
    ...
    if(!isset($_SESSION["adminLogin"])){
        ...
        if(isset($_POST["Add_Data"])){
            ...
            $query= "INSERT INTO restaurantowner(RO_Name,RO_Password,RO_Email,RO_PhoneNum,RO_Address, RO_Poscode, RO_State) VALUES('$name','$pass','$email','$phoneNum','$address', '$poscode', '$state')";
...
<body>
    ...
    <div class="flexbox">
        <div class="title"><h1>Add New Restaurant Owner</h1></div>
