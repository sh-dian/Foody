<?php
     ...
     if(isset($_POST["login"])){
         ...
         $checkID = mysqli_query($con, "SELECT Rider_ID FROM riderlogin WHERE Rider_ID='$uname' AND Rider_Password='$password' limit 1");

         if (mysqli_num_rows($checkID) > 0) {

            $row = myslqi_fetch_assoc($checkID);
...
<head>
    ...
    <link rel="stylesheet" href="riderlogin.css">
